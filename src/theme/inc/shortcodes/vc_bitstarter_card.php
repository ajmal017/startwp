...
class WPBakeryShortCode_Bitstarter_Card extends  WPBakeryShortCode
{
    ...
    public function content($atts, $content = null)
    {
        ...
        $output .= '<div class="bitstarterCard__title" style="color: ' . $title_color . '"><span>' . $title . '</span></div>';
    
        $output .= '<div class="bitstarterCard__content" style="border-color: ' . $line_color . '">' . wpb_js_remove_wpautop($content, true) . '</div>';
